...
**State ID:** ICP-STATE-20260923-08  
...
17. **REQ-PERM-001 / Part 5** — Academic Committee, Reviewer, Academic Decision Authority: **NEXT**.
18. **REQ-NFR-001 / INT-BASE-001** — Non-functional and integration baselines: **PENDING**.
19. **GOV-GATE-001** — Phase 0 consistency audit and Phase 1 readiness: **PENDING**.
